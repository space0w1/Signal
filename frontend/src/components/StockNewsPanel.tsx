...
export function StockNewsPanel({ ticker, date }: Props) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4 shadow-sm">
      <div className="mb-3 text-sm font-medium text-gray-700 dark:text-gray-300">News</div>
